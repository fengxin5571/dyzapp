<?php /* Smarty version Smarty-3.1.12, created on 2016-10-19 10:51:30
         compiled from ".\tpl\index\kh_tuijian.html" */ ?>
<?php /*%%SmartyHeaderCode:89465800ab04137e64-25831805%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c8791b9e94ab5ada0b76259c6435d24267227c0c' => 
    array (
      0 => '.\\tpl\\index\\kh_tuijian.html',
      1 => 1476845489,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '89465800ab04137e64-25831805',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5800ab04174f00_65172804',
  'variables' => 
  array (
    'row' => 0,
    'a' => 0,
...
<?php if ($_valid && !is_callable('content_5800ab04174f00_65172804')) {function content_5800ab04174f00_65172804($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
				...
				<li class="right gmyx_select">
					<div class="select_box clearfix">
						...
						<select name="leibie" style='float:right;width:140px;'>
							<option value="1">自然上客</option>
							<option value="2">外拓</option>
						</select>
					</div>
					<div class="select_box clearfix">
						<span>盘名</span>
...
<script>
	...
	function add_kehu(){
		...
		if(name.length==0){
			...
			$.ajax({
			   type: "POST",
			   url: "index.php?action=zygw_index&do=kh_add",
