<?php /* Smarty version Smarty-3.1.12, created on 2015-12-03 09:28:27
         compiled from ".\tpl\p2p\borrow\enterpriseborrow_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:267115642ddd4c976b7-09329847%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d8954425047c4068f95c549e944b21e2f189030' => 
    array (
      0 => '.\\tpl\\p2p\\borrow\\enterpriseborrow_list.htm',
      1 => 1449106104,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '267115642ddd4c976b7-09329847',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5642ddd4ceb579_17537656',
  'variables' => 
  array (
    'list' => 0,
    'row' => 0,
...
<?php if ($_valid && !is_callable('content_5642ddd4ceb579_17537656')) {function content_5642ddd4ceb579_17537656($_smarty_tpl) {?>
<form id="pagerForm" method="post" action="index.php?action=enterpriseborrow">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="index.php?action=enterpriseborrow" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">				
				...
				<li><a class="edit" href="?action=enterpriseborrow&do=edit&id={id}" target="dialog" width="1000" height="750" rel="enterpriseborrowedit" mask="true"><span>察看</span></a></li>
...
元</td>
						...
						<td><?php if ($_smarty_tpl->tpl_vars['row']->value['status']==1){?><span style="color:red;">未审核</span><?php }elseif($_smarty_tpl->tpl_vars['row']->value['status']==2){?>初审通过<?php }elseif($_smarty_tpl->tpl_vars['row']->value['status']==4){?>复审通过<?php }elseif($_smarty_tpl->tpl_vars['row']->value['status']==5){?>投标已结束<?php }?></td>
