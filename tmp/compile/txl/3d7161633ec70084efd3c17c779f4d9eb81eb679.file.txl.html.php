...
<?php if ($_valid && !is_callable('content_58a41112880ef5_17295714')) {function content_58a41112880ef5_17295714($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['flag']->value==0){?>
<!-- 默认通讯录 -->
...
?>
	<div class="ej_tx" tapmode='tap-active' onclick="open_dhk(<?php echo $_smarty_tpl->tpl_vars['zbrow']->value['id'];?>
)" >
		<div class="cir" >
...
?>
			<div class="ej_tx"  tapmode='tap-active' onclick="open_dhk(<?php echo $_smarty_tpl->tpl_vars['row']->value['user']['id'];?>
)" >
				<div class="cir" >
...
<!-- 群聊通讯录 -->
<li onclick="zhankai(this)" tapmode='tap-active' zk='1'>
	<div class="cir crr"><span>总部</span><div class="shuxian"></div></div>
	<p>总部</p>
</li>
<div class="ej_box">
	<?php  $_smarty_tpl->tpl_vars['zbrow'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['zbrow']->_loop = false;
...
?>
	<?php if ($_smarty_tpl->tpl_vars['txlrow']->value['szm']==$_smarty_tpl->tpl_vars['s']->value['szm']){?>
	<li onclick="zhankai(this)" tapmode='tap-active' zk='1'>
		<div class="cir crr"><span><?php echo $_smarty_tpl->tpl_vars['txlrow']->value['name'];?>
</span><div class="shuxian"></div></div>
		<p><?php echo $_smarty_tpl->tpl_vars['txlrow']->value['fgsname'];?>
-<?php echo $_smarty_tpl->tpl_vars['txlrow']->value['name'];?>
</p>
